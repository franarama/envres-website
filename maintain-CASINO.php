...
<body>
    ...
    <h1 id="editTitle">Reservations for Casino</h1>
...
<?php
            ...
            $sSQL= "SELECT e.id,e.owner,e.startdate,e.enddate,eg.name AS env_name,res_type,p.name AS project_name,e.description FROM `env_reservations` e
                    ...
                    LEFT JOIN projects p ON e.project_id = p.id WHERE eg.enabled=1 AND res_type=1 ORDER BY $sql_orderBy, startdate ASC";
        ...
        <tr>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'env_name_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=env_name_asc">Env<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if($_GET['orderBy'] == 'env_name_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=env_name_desc">Env<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=env_name_asc">Env</a>';
                }
                ?>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'project_name_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=project_name_asc">Project<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if ($_GET['orderBy'] == 'project_name_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=project_name_desc">Project<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=project_name_asc">Project</a>';
                }
                ?>
            </td>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'description_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=description_asc">Description<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if ($_GET['orderBy'] == 'description_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=description_desc">Description<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=description_asc">Description</a>';
                }
                ?>
            </td>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'owner_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=owner_asc">Owner<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if ($_GET['orderBy'] == 'owner_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=owner_desc">Owner<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=owner_asc">Owner</a>';
                } 
                ?>
            </td>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'startdate_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=startdate_asc">Start<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if ($_GET['orderBy'] == 'startdate_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=startdate_desc">Start<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=startdate_asc">Start</a>';
                }
                ?>
            </td>
            ...
            <td>
                ...
                if ($_GET['orderBy'] == 'enddate_desc') {
                    print '<a href="maintain-CASINO.php?orderBy=enddate_asc">End<img src="Images/downArrow.png" width="10px" height="10px"></a>';
                }
                else if ($_GET['orderBy'] == 'enddate_asc') {
                    print '<a href="maintain-CASINO.php?orderBy=enddate_desc">End<img src="Images/upArrow.png" width="10px" height="10px"></a>';
                }
                else {
                    print '<a href="maintain-CASINO.php?orderBy=enddate_asc">End</a>';
                }
                ?>
            </td>
